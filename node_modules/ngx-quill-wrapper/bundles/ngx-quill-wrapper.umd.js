(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('quill'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'quill', '@angular/common'], factory) :
    (global = global || self, factory((global.zef = global.zef || {}, global.zef.ngxQuillWrapper = {}), global.ng.core, global.Quill, global.ng.common));
}(this, function (exports, core, Quill, common) { 'use strict';
     ...
     */
    /** @type {?} */
    var QUILL_CONFIG = new core.InjectionToken('QUILL_CONFIG');
    ...
    var QuillDirective = /** @class */ (function () {
        function QuillDirective(zone, elementRef, differs, service, defaults) {
            ...
            this.editorCreate = new core.EventEmitter();
        ...
        QuillDirective.ctorParameters = function () { return [
            ...
            { type: QuillService },
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [QUILL_CONFIG,] }] }
        ]; };
        QuillDirective.propDecorators = {
            disabled: [{ type: core.Input }],
            autoToolbar: [{ type: core.Input }],
            realToolbar: [{ type: core.Input }],
            config: [{ type: core.Input, args: ['quill',] }],
            modules: [{ type: core.Input, args: ['modules',] }],
            blur: [{ type: core.Output }],
            focus: [{ type: core.Output }],
            editorCreate: [{ type: core.Output }],
    ...
    var QuillComponent = /** @class */ (function () {
        ...
        QuillComponent.propDecorators = {
            ...
            useQuillClass: [{ type: core.HostBinding, args: ['class.quill',] }, { type: core.Input }],
            blur: [{ type: core.Output }],
            focus: [{ type: core.Output }],
            ...
            contentChange: [{ type: core.Output }],
            selectionChange: [{ type: core.Output }],
            directiveRef: [{ type: core.ViewChild, args: [QuillDirective,] }]
        };
    ...
    var QuillModule = /** @class */ (function () {
        ...
        QuillModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [common.CommonModule, QuillComponent, QuillDirective],
    ...
    exports.QuillDirective = QuillDirective;
    exports.QUILL_CONFIG = QUILL_CONFIG;
    exports.QuillConfig = QuillConfig;
...
//# sourceMappingURL=ngx-quill-wrapper.umd.js.map
